...
import uk.ac.ebi.quickgo.data.GOSourceFiles.EAnnotationGuidelineInfo;
import uk.ac.ebi.quickgo.data.GOSourceFiles.EGOTerm;
import uk.ac.ebi.quickgo.data.GOSourceFiles.EPlannedGOChangeInfo;
import uk.ac.ebi.quickgo.data.GOSourceFiles.EProteinComplex;
import uk.ac.ebi.quickgo.data.GOSourceFiles.ETaxonConstraint;
import uk.ac.ebi.quickgo.data.GOSourceFiles.ETaxonUnion;
import uk.ac.ebi.quickgo.data.GOSourceFiles.ETermTaxonConstraint;
