...
public class TaxonConstraint implements JSONSerialise,Comparable<TaxonConstraint> {
	...
	public String getSourcesString(){
		...
		for(PMID source : this.sources){
			sourcesString.add(source.getPmid());
		}
		return StringUtils.arrayToCommaDelimitedString(sourcesString.toArray());
	}
