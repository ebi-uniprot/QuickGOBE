...
public class CoOccurringTerm implements Comparable<CoOccurringTerm>{
	...
	public float calculateProbabilitySimilarityRatio(float selected) {
		...
		Preconditions.checkArgument(selected!=0, "CoOccurringTerm::calculateProbabilitySimilarityRatio The value for" +
	...
	public int compareTo(CoOccurringTerm o) {
		if(this.getSimilarityRatio() == o.getSimilarityRatio()) return 0;
	...
	public boolean equals(Object o) {
		...
		if (Float.compare(that.together, together) != 0) return false;
		if (Float.compare(that.compared, compared) != 0) return false;
