...
class AnnotationParsingHelper {
    ...
    static final Pattern ANNOTATION_EXTENSION_REGEX = Pattern.compile(PIPE_SEPARATED_CSVs_FORMAT.formatted(
            WORD_LBRACE_WORD_RBRACE_FORMAT, WORD_LBRACE_WORD_RBRACE_FORMAT,
            WORD_LBRACE_WORD_RBRACE_FORMAT, WORD_LBRACE_WORD_RBRACE_FORMAT));
    static final Pattern ANNOTATION_PROPERTIES_REGEX = Pattern.compile(PIPE_SEPARATED_CSVs_FORMAT.formatted(
