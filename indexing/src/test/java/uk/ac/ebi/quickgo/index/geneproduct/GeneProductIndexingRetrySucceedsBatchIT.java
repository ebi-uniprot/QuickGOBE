...
@SpringBootTest(classes = {GeneProductConfig.class, GeneProductIndexingRetrySucceedsBatchIT
                .RetryConfig.class, DefaultBatchConfiguration.class, BatchConfig.class})
@SpringBatchTest
class GeneProductIndexingRetrySucceedsBatchIT extends SolrContainerTestSetup {
    @Autowired
