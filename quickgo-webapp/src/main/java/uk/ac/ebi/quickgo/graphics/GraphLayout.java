...
public class GraphLayout<N extends IPositionableNode, E extends IRoutableEdge<N>> {
    ...
    public GraphLayout(IGraph<N, E> graph, Orientation orientation) {
        ...
        for (N n : graph.getNodes()) {
            HierarchicalNode hnode = (orientation == Orientation.TOP || orientation == Orientation.BOTTOM) ? new HierarchicalNode(n, n.getHeight(), n.getWidth()) : new HierarchicalNode(n, n.getWidth(), n.getHeight());
            nodeMap.put(n, hnode);
...
// fields
    ...
    private GenericGraph<HierarchicalNode, HierarchicalEdge> hierarchicalGraph = new GenericGraph<HierarchicalNode, HierarchicalEdge>();
