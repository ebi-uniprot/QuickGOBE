...
public class SlimmingGraphController {
    ...
    public String inactivateSlimmingTerm(
            @RequestParam(value = "inactiveSlimmingGraphTermId", defaultValue = "", required = false)
            String inactiveSlimmingGraphTermId,
            HttpServletRequest httpRequest, HttpSession session, Model model) {

        Map<String, String> activeSlimmingGraphTerms =
                getTermsFromSession(SlimmingUtil.ACTIVE_SLIMMING_GRAPH_TERMS_ATTRIBUTE, session);
    ...
    public String activateSlimmingTerm(
            @RequestParam(value = "activeSlimmingGraphTermId", defaultValue = "", required = false)
            String activeSlimmingGraphTermId,
            HttpServletRequest httpRequest, HttpSession session, Model model) {
