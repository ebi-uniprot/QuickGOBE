...
public class ChartService {
	...
	private GraphImage createRenderableImage(String termsIds){
		...
		OntologyGraph ontologyGraph = OntologyGraph.makeGraph(termSet, EnumSet
				.of(RelationType.USEDIN, RelationType.ISA, RelationType.PARTOF,
						RelationType.REGULATES, /*RelationType.HASPART,*/
