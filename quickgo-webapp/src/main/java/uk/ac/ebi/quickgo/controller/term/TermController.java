...
public class TermController {
    ...
    public String termInformation(HttpSession session, HttpServletRequest request,
        ...
        if (id.contains(GOTerm.GO)) {
            ...
            // Co-occurring stats
            allCoOccurrenceStatsTerms =
                    (TreeSet) miscellaneousService.allCOOccurrenceStatistics(id.replaceAll("GO:", ""));
            nonIEACOOccurrenceStatistics =
                    (TreeSet) miscellaneousService.nonIEACOOccurrenceStatistics(id.replaceAll("GO:", ""));
