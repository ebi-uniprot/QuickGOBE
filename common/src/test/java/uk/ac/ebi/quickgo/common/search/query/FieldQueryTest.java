...
import uk.ac.ebi.quickgo.common.search.query.FieldQuery;
import uk.ac.ebi.quickgo.common.search.query.QueryVisitor;
...
public class FieldQueryTest {
    ...
    public void createFieldAndValueQuery() throws Exception {
        ...
        FieldQuery query = new FieldQuery(field, value);
