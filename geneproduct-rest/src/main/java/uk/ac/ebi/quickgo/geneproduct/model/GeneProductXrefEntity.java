...
public class GeneProductXrefEntity {
	...
	public Pattern localIDSyntax;			//E.g. regex for validation  ([OPQ][0-9][A-Z0-9]{3}[0-9]|[A-NR-Z]([0-9][A-Z][A-Z0-9]{2}){1,2}[0-9])((-[0-9]+)|:PRO_[0-9]{10}|:VAR_[0-9]{6}){0,1}
	public String URLSyntax;				//E.g. http://www.uniprot.org/uniprot/[example_id]/
	public GeneProductXrefEntity.Key dbKey;


	public GeneProductXrefEntity(String database, String entityType, String entityTypeName, String localIDSyntax, String URLSyntax) {
		this.database = database;
		this.entityType = entityType;
		this.entityTypeName = entityTypeName;
		Objects.requireNonNull(localIDSyntax, "The regex for the validation of ids from " + database +" is null and therefore invalid");
	...
	public static class Key{
		...
		public boolean equals(Object o) {
			...
			if (database != null ? !database.equals(key.database) : key.database != null) return false;
