...
public class ExtensionDatabasesPresetsConfig {
    ...
    @Bean
    public Step extensionDatabasesProductStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
            Integer chunkSize,
        ...
        return new StepBuilder(EXTENSION_DB_LOADING_STEP_NAME, jobRepository)
