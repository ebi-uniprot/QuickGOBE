...
public class PresetItemTest {
    ...
    public void nullNameCausesException() {
        new PresetItem(null, VALID_DESCRIPTION, VALID_RELEVANCY);
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullDescriptionCausesException() {
        new PresetItem(VALID_NAME, null, VALID_RELEVANCY);
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullRelevancyCausesException() {
        new PresetItem(VALID_NAME, VALID_DESCRIPTION, null);
    }
    ...
    public void canCreateValidPreset() {
        PresetItem presetItem = new PresetItem(VALID_NAME, VALID_DESCRIPTION, VALID_RELEVANCY);
