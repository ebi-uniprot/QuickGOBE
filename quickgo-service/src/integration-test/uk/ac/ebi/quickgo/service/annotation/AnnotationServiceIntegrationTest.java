...
public class AnnotationServiceIntegrationTest {
	...
	public static void main(String[] args) {
		...
		fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(),0,-1);
		logger.info("Annotations assigned by AgBase and qualifier involved_in and not IMP go evidence: " + fileteredAnnotations.size());
		...
		fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(),0,-1);
		logger.info("Annotations for goID GO:0000166, GO evidence IEA and not InterPro: " + fileteredAnnotations.size());
		...
		fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(),0,-1);
		logger.info("Annotations assigned by InterPro and Function aspect and not for the protein A0A002: " + fileteredAnnotations.size());
