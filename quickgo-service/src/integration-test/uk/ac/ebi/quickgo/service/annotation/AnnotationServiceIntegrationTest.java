...
//    final static Logger logger = LoggerFactory.getLogger(AnnotationServiceIntegrationTest.class);
//
//    public static void main(String[] args) {
//
//        appContext = new ClassPathXmlApplicationContext("service-beans.xml", "common-beans.xml",
//                "src/main/resources/query-beans.xml");
...
//        List<Annotation> fileteredAnnotations =
//                annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info("Annotations with gene product A0SDZ9: " + fileteredAnnotations.size());
//
//        // Taxon Id 9913
...
//        logger.info("Annotations with taxon id 9913: " + fileteredAnnotations.size());
//
...
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info("Annotations with taxon id 9606 OR 10090: " + fileteredAnnotations.size());
//
...
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info("Annotations with gene product A0SDZ9 and GO_REFs: " + fileteredAnnotations.size());
//
...
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info("Annotations assigned by AgBase: " + fileteredAnnotations.size());
//
...
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info("Annotations assigned by AgBase or InterPro: " + fileteredAnnotations.size());
//
//        //******************
//        // Advanced queries
//        //******************
...
//        annotationParameters = new AnnotationParameters();
//        annotationParameters.addParameter(AnnotationWebServiceField.ADVANCEDQUERY.name(),
//                Arrays.asList("assignedBy:AgBase AND (qualifier:involved_in AND NOT goEvidence:IMP)"));
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info("Annotations assigned by AgBase and qualifier involved_in and not IMP go evidence: " +
//                fileteredAnnotations.size());
//
//        // Advanced query "goID:GO:0000166 AND goEvidence:IEA AND NOT with:InterPro*"
//        annotationParameters = new AnnotationParameters();
//        annotationParameters.addParameter(AnnotationWebServiceField.ADVANCEDQUERY.name(),
//                Arrays.asList("goID:GO:0000166 AND goEvidence:IEA AND NOT with:InterPro*"));
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//        logger.info(
//                "Annotations for goID GO:0000166, GO evidence IEA and not InterPro: " + fileteredAnnotations.size());
//
//        // Advanced query "assignedBy:InterPro AND goAspect:Function AND NOT dbObjectID:A0A002"
//        annotationParameters = new AnnotationParameters();
//        annotationParameters.addParameter(AnnotationWebServiceField.ADVANCEDQUERY.name(),
//                Arrays.asList("assignedBy:InterPro AND goAspect:Function AND NOT dbObjectID:A0A002"));
//
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//
//        logger.info("Annotations assigned by InterPro and Function aspect and not for the protein A0A002: " +
//                fileteredAnnotations.size());
//
//        //************************************
...
//        annotationParameters = new AnnotationParameters();
//        annotationParameters.addParameter(AnnotationWebServiceField.ADVANCEDQUERY.name(),
//                Arrays.asList("qualifier:involved_in AND NOT goEvidence:IMP"));
//        annotationParameters.addParameter(AnnotationField.ASSIGNEDBY.name(), Arrays.asList("AgBase"));
//
//        fileteredAnnotations = annotationService.retrieveAnnotations(annotationParameters.toSolrQuery(), 0, -1);
//
...
//                .addParameter(AnnotationWebServiceField.ADVANCEDQUERY.name(), Arrays.asList("NOT dbObjectID:A0A002"));
