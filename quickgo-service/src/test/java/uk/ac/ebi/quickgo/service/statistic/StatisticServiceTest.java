...
public class StatisticServiceTest {
	...
	public void testAnnotationStatsAllAnnotationsAssignedBy(){
		...
		AnnotationService annotationService = context.mock(AnnotationService.class);
		StatisticsUtil statisticsUtil = new StatisticsUtil();
		statisticsUtil.annotationService = annotationService;
		...
		context.checking(new Expectations() {
			{	
				...
				allowing(statisticService.statisticsUtil.annotationService).getTotalNumberAnnotations(query);
