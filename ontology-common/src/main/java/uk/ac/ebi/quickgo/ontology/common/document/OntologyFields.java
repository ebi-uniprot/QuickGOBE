...
public class OntologyFields {
    ...
    public final static String PROTEIN_COMPLEXS = "proteinComplexes";
    ...
    public static final class Retrievable extends OntologyFields {
        ...
        public final static String PROTEIN_COMPLEXS = storeAndGet(VALUES, OntologyFields.PROTEIN_COMPLEXS);
