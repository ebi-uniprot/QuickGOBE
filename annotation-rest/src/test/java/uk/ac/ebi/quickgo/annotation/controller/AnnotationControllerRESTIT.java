...
public class AnnotationControllerRESTIT {
    ...
    public void filterFor1GOTermBy0ValidDescendantMeansFilterEverything()
        ...
        expectRestCallHasDescendants(singletonList(goId(1)), emptyList(), singletonList(emptyList()));

        ResultActions response = mockMvc.perform(
                get(SEARCH_RESOURCE)
                        .param(USAGE, DESCENDANTS_USAGE)
                        .param(GO_ID_PARAM.getName(), goId(1)));
    ...
    public void filterFor1GOTermBy1ValidDescendant()
        ...
        expectRestCallHasDescendants(singletonList(goId(1)), emptyList(), singletonList(singletonList(goId(3))));
    ...
    public void filterFor2GOTermsBy0ValidDescendantsMeansFilterEverything() throws Exception {
        ...
        expectRestCallHasDescendants(asList(goId(1), goId(2)), singletonList(IS_A), asList(emptyList(), emptyList()));

        ResultActions response = mockMvc.perform(
                get(SEARCH_RESOURCE)
                        .param(USAGE, DESCENDANTS_USAGE)
                        .param(GO_ID_PARAM.getName(), goId(1) + "," + goId(2))
                        .param(USAGE_RELATIONS, IS_A));
    ...
    public void filterFor2GOTermsBy1ValidDescendant() throws Exception {
        ...
        ResultActions response = mockMvc.perform(
                get(SEARCH_RESOURCE)
                        .param(USAGE, DESCENDANTS_USAGE)
                        .param(GO_ID_PARAM.getName(), csv(goId(1), goId(2))));
    ...
    public void goTermWithTwoNullDescendantsListAndOneValidDescendantsProducesErrorShowingBothIds() throws Exception {
        ...
        ResultActions response = mockMvc.perform(
                get(SEARCH_RESOURCE)
                        .param(USAGE, DESCENDANTS_USAGE)
                        .param(GO_ID_PARAM.getName(), csv(goId(1), goId(2), goId(3))));
