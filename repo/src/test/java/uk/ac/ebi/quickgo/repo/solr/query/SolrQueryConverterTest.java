...
public class SolrQueryConverterTest {
    ...
    public void solrQueryReferencesCorrectRequestHandlerName() throws Exception {
        String field = "field1";
        String value = "value1";
        GoQuery fieldQuery = GoQuery.createQuery(field, value);
    ...
    public void convertQueryRequestWithValueOnlyQuery() throws Exception {
        String value = "value1";
        GoQuery fieldQuery = GoQuery.createQuery(value);
    ...
    public void convertQueryRequestWithComplexQuery() throws Exception {
        GoQuery complexQuery = createComplexQuery();
    ...
    private GoQuery createComplexQuery() {
        GoQuery query1 = GoQuery.createQuery("field1","value1");
        GoQuery query2 = GoQuery.createQuery("field2","value2");

        GoQuery andQuery = query1.and(query2);

        GoQuery query3 = GoQuery.createQuery("field3","value3");
    ...
    public void convertQueryRequestWithQueryAndFilterQuery() throws Exception {
        ...
        GoQuery filterFieldQuery = GoQuery.createQuery(filterField, filterValue);
