...
public class QueryRequestTest {
    ...
    public void buildsQueryRequestOnlyWithgetQuery() throws Exception {
        GoQuery query = GoQuery.createQuery("field1", "value1");
    ...
    public void buildsQueryRequestWithQueryAndFiltergetQuery() throws Exception {
        ...
        GoQuery filterQuery1 = GoQuery.createQuery("field1", "value1");
        GoQuery filterQuery2 = GoQuery.createQuery("field1", "value1");
    ...
    public void addFilterQueryToQueryRequest() throws Exception {
        ...
        GoQuery filterQuery = GoQuery.createQuery("filter", "value");
