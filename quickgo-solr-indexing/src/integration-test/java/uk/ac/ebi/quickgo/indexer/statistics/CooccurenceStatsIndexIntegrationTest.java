 ...
 */
public class CooccurenceStatsIndexIntegrationTest {
	...
	public static void main(String[] args) {
		...
		QuickGOCOOccurrenceStatsIndexer statsIndexer = new QuickGOCOOccurrenceStatsIndexer();
		...
		statsIndexer.annotationRetrieval = annotationRetrieval;
