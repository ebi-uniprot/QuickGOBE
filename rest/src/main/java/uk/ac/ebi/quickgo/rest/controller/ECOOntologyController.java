...
public class ECOOntologyController {
     ...
     * @return
     */
    @RequestMapping(value = ECO_REQUEST_MAPPING_BASE + "/{id}/constraints", produces = {MediaType
            .APPLICATION_JSON_VALUE})
    public ResponseEntity<ECOTerm> findGOTermTaxonConstraints(@PathVariable(value = "id") String id) {
