...
public class OntologyGraph implements OntologyGraphTraversal {
    ...
    private static final Set<String> STOP_NODES =
            Stream.of(MOLECULAR_FUNCTION_STOP_NODE, BIOLOGICAL_PROCESS_STOP_NODE, CELLULAR_COMPONENT_STOP_NODE).collect(Collectors.toSet());
